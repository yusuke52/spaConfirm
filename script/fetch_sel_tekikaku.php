...
/**
 * 適格請求書情報取得処理
 * （受け取った適格請求書発行事業者Noをキーに、JSONから適格請求書発行事業者情報を取得する。
 * 　なお、人格のない社団等のJSONファイルのみ取得可能。その他のファイルは、データ件数が多いためエラー発生する。
 * 　その他のファイルにも対応するには、一旦公表情報をＤＢにインポートする機能を追加作成し、そこからデータ抽出するように作り直しが必要。）
 */
try {
